package com.petSmile.StepDefinition2;
...
public class Steps {
	...
	@When("Ingresa Username {string} y Password {string} otro")
	...
	public void IniciarSesion() {
		...
		assertEquals("PetSmile - Inicio", driver.getTitle());
	}
